...
# LOCAL
eval prompt_icon='$FG[114]'
eval prompt_line='$FG[114]'

eval username='$FG[114]'
eval username_icon='$FG[114]'
...
PR_TIME='%F${timestamp}[%D{%d.%m.%Y} %D{%L:%M:%S}]%f'
...
PROMPT="$PR_PROMPT_1 ${time}%f${user}$host ${current_dir} ${git_branch}
